...
requirements = json.loads(json_requirements)

print(catalog["courses"]["CS-1210"])

for id in catalog["courses"]:
    course = catalog["courses"][id]
    name = course["name"]
    desc = course["description"]
    credits = course["credits"]
    print(f"INSERT INTO `HMS_Courses`(`courseID`, `name`, `description`, `credits`) VALUES ({id}, {name}, {desc}, {credits})")